...
import mod.azure.aftershock.client.model.tropical.TropicalShreikerEntityModel;
...
public class TropicalShreikerEntityRenderer extends GeoEntityRenderer<AmericanShreikerEntity> {

	public TropicalShreikerEntityRenderer(EntityRendererProvider.Context context) {
		super(context, new TropicalShreikerEntityModel());
