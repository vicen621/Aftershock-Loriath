...
public final class AftershockSensors {
	...
	public static final Supplier<SensorType<NearbyLightsBlocksSensor<?>>> NEARBY_LIGHT_BLOCKS = register(
			"nearby_light_blocks_aftershock", NearbyLightsBlocksSensor::new);

	public static final Supplier<SensorType<ItemEntitySensor<?>>> FOOD_ITEMS = register("food_items_aftershock",
