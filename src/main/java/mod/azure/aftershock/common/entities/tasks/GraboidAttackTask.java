...
public class GraboidAttackTask<E extends BaseEntity> extends CustomDelayedMeleeBehaviour<E> {
	...
	public GraboidAttackTask(int delayTicks) {
		super(delayTicks);
	}
	 ...
	 * @return this
	 */
	public GraboidAttackTask<E> attackInterval(Function<E, Integer> supplier) {
	...
	protected void stop(E entity) {
		this.target = null;
		entity.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 30, 100, false, false));
	}
