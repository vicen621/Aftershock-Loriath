...
public enum AttackType {
	NONE(GenericAttackType.NONE), NORMAL(GenericAttackType.NORMAL), HOLD(GenericAttackType.HOLD), ATTACK(GenericAttackType.ATTACK), BITE(GenericAttackType.BITE), GRAB1(GenericAttackType.GRAB1), GRAB2(GenericAttackType.GRAB2);
